...
void framerenderer::render(glm::mat4& view, glm::mat4& projection)
{
	...
	Renderer.setUniformFloat("ambient", .1);
	Renderer.setUniformFloat("diffuse", 1.0);
	Renderer.setUniformFloat("specular", 100.0);
	Renderer.setUniformFloat("specularPower", 100.0);
